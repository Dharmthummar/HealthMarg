...
export default function Toast({ message, type = 'success', onClose }) {
  ...
  return (
    <div className="fixed bottom-24 left-1/2 -translate-x-1/2 z-[60] w-11/12 max-w-sm bg-slate-900/95 text-white border border-slate-700/90 rounded-2xl shadow-2xl p-3.5 flex items-center justify-between gap-3 animate-slideUp backdrop-blur-md">
